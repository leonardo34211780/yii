...
/**
 * This is the model class for table "taxa_emprestimo".
 *
 * The followings are the available columns in table 'taxa_emprestimo':
 * @property integer $taxa_id
 * @property string $valor_limite
 * @property string $taxa_mes
 */
class TaxaEmprestimo extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('valor_limite, taxa_mes', 'length', 'max'=>16),
	 ...
	 * @return TaxaEmprestimo the static model class
	 */
